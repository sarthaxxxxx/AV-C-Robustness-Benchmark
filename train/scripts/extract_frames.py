...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_path', dest='video_path', type=str, default='/mnt/user/saksham/AV_robust/data/AVSync15/videos')
    parser.add_argument('--out_dir', dest='out_dir', type=str, default='/mnt/data2/saksham/AV_robust/avsync15/frames')
